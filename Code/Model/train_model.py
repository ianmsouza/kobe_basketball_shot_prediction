...
def treinar_modelos(caminho_base_treino, caminho_modelo_saida):
    ...
    setup(data=df_train, target='shot_made_flag', log_experiment=True, experiment_name='Treinamento', session_id=42)
    ...
    # Logar métricas manualmente caso run esteja ativa
